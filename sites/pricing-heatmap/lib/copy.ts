...
export const homeCopy = {
  en: {
    badge: "Hotjar $39+/mo · Clarity is free but no pricing insights · we ship heatmaps for $9.9/mo",
    title: "Pricing page heatmaps for indie hackers",
    subtitle:
    ...
    testimonials: [
      {
        ...
        text: "Hotjar wanted $39/mo just to see scroll depth. Indie Pricing Heatmap showed me 62% drop at tier selection — fixed the badge, conversion up 18%.",
      },
      {
        name: "Mia C.",
        role: "Indie hacker",
  ...
  zh: {
    badge: "Hotjar $39+/月 · Clarity 免费但无定价洞察 · 我们 $9.9/月热力图",
    title: "独立开发者的定价页热力图",
    subtitle:
    ...
    testimonials: [
      {
        name: "Alex T.",
        role: "一人 SaaS 创始人",
        text: "Hotjar 只看滚动深度就要 $39/月。Indie Pricing Heatmap 指出 62% 在选档位流失 — 加了角标后转化涨 18%。",
      },
      {
        name: "Mia C.",
        role: "独立开发者",
...
export const joinCopy = {
  en: {
    title: "Join Indie Pricing Heatmap",
  ...
  zh: {
    title: "订阅定价页热力图",
    subtitle: "一口价，定价页热力图不限次数。不按会话收费。",
    recommended: "推荐",
    monthly: "月付",
    perMonth: "/月",
