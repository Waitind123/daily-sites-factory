...
export const guideCopy = {
  en: {
    ...
    sections: [
      {
        h2: "Why solo freelancers need a dedicated invoice tool",
        paragraphs: ["Spreadsheets and Word templates break down fast when you bill more than twice a month:"],
        list: [
          "Invoice numbers — manual tracking leads to duplicates and tax headaches",
          "Due dates — clients ignore invoices without clear payment deadlines",
          "Receipt generation — you need proof of payment for your own bookkeeping",
          "Outstanding tracker — knowing who owes you money without opening 5 spreadsheets",
        ],
        after: [
          "The classic solo freelancer billing loop: finish project → send invoice → wait 15 days → send reminder → mark paid → send receipt. You don't need CRM pipelines for this. You need: invoice creation, payment status, and receipt export.",
        ],
      },
      {
        h2: "2026 freelance invoice tools compared",
        tools: [
          {
            h3: "HoneyBook — $66+/mo",
            p: "Full client management suite: proposals, contracts, invoicing, scheduling. Great for wedding photographers and creative agencies. Expensive when you just need to bill 3–4 clients per month. The 89% price hike pushed many loyal users to alternatives.",
          },
          {
            h3: "Bonsai — $24+/mo",
            p: "Proposals, contracts, invoicing, time tracking, and tax estimates. Solid US-focused toolkit. Transaction fees on lower tiers. Moving upmarket toward agencies — solo features still work but pricing reflects team tools you won't use.",
          },
          {
            h3: "FreshBooks — $19+/mo",
            p: "Real accounting features: expense tracking, financial reports, tax categories. Strong for freelancers who need bookkeeping, not just invoicing. No contract or proposal tools in the basic plan.",
          },
          {
            h3: "Wave — free",
            p: "Free invoicing and accounting. Monetizes through payment processing (2.9% + $0.60). Works for occasional invoices but lacks branded receipts and outstanding dashboards. US/Canada focused.",
          },
          {
            h3: "Indy — $12.50/mo",
      ...
      {
        h2: "What to look for in a freelance invoice tool",
        paragraphs: ["At indie scale, these features matter more than enterprise bells and whistles:"],
        list: [
          "Flat pricing — no per-client fees or transaction cuts on top of Stripe",
          "Auto invoice numbers — INV-XXXX format, no manual spreadsheet",
          "Due date defaults — 15 or 30 days, set automatically",
          "Receipt on payment — one click, not a separate document",
          "Markdown or PDF export — send via email without logging into a portal",
      ...
      {
        h2: "How to switch from HoneyBook or Bonsai in one afternoon",
        paragraphs: [
          "Migration doesn't need to be painful. Most freelancers have 2–5 active clients, not 200.",
          "Step 1: Export your client list from HoneyBook/Bonsai (name, email, project). Step 2: Create your first invoice in the new tool with a real pending project. Step 3: Send the invoice via email — clients don't care which tool you use as long as the invoice looks professional.",
          "Step 4: Mark existing paid projects as reference in your spreadsheet. Step 5: Cancel the old subscription before the next renewal. Most switches complete in under 2 hours.",
        ],
      },
      {
  ...
  zh: {
    ...
    sections: [
      {
        h2: "为什么自由职业者需要专用发票工具",
        paragraphs: ["每月开票超过两次后，表格和 Word 模板很快就不够用了："],
        list: [
          "发票编号 — 手工追踪容易重复，报税时头疼",
          "到期日 — 没有明确付款期限，客户容易忽视",
          "收据生成 — 你需要付款凭证做自己的账",
          "待收追踪 — 不用打开五张表格就知道谁还欠钱",
        ],
        after: [
          "典型的自由职业者开账循环：完成项目 → 开发票 → 等 15 天 → 提醒 → 标记已付 → 发收据。你不需要 CRM 漏斗，只需要：发票创建、付款状态、收据导出。",
        ],
      },
      {
        h2: "2026 年自由职业者发票工具对比",
        tools: [
          {
            h3: "HoneyBook — $66+/月",
            p: "全套客户管理：报价、合同、发票、日程。适合婚礼摄影师和创意机构。每月只给 3–4 个客户开票时太贵。89% 涨价让很多老用户转向替代品。",
          },
          {
            h3: "Bonsai — $24+/月",
            p: "报价、合同、发票、工时、税务估算。美国市场功能全面。低档有交易费。正转向代理商市场 — 个人功能仍可用，但定价包含你用不上的团队工具。",
          },
          {
            h3: "FreshBooks — $19+/月",
            p: "真正的会计功能：费用追踪、财务报表、税类。适合需要记账而不只是开票的人。基础版没有合同或报价工具。",
          },
          {
            h3: "Wave — 免费",
            p: "免费发票与会计，通过支付处理（2.9% + $0.60）变现。偶尔开票够用，但缺少品牌收据和待收面板。主要面向美加。",
          },
          {
            h3: "Indy — $12.50/月",
      ...
      {
        h2: "自由职业者发票工具该看什么",
        paragraphs: ["在独立开发者规模，这些功能比企业级花架子更重要："],
        list: [
          "一口价 — 不按客户收费，Stripe 之上不再抽交易费",
          "自动发票号 — INV-XXXX 格式，告别手工表格",
          "默认到期日 — 15 或 30 天自动设置",
          "付款即收据 — 一键生成，不用另做文档",
          "Markdown 或 PDF 导出 — 邮件发送，不必登录门户",
          "待收面板 — 一屏看清未付总额",
        ],
        after: [
      ...
      {
        h2: "一个下午从 HoneyBook 或 Bonsai 迁移",
        paragraphs: [
          "迁移不必痛苦。大多数自由职业者只有 2–5 个活跃客户，不是 200 个。",
          "第一步：从 HoneyBook/Bonsai 导出客户列表（姓名、邮箱、项目）。第二步：在新工具里用真实待结项目创建第一张发票。第三步：邮件发送 — 客户不在乎你用什么工具，只要发票看起来专业。",
          "第四步：在表格里把已付项目标为参考。第五步：下次续费前取消旧订阅。大多数迁移 2 小时内完成。",
        ],
      },
      {
