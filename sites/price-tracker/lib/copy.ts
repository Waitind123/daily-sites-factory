...
export const homeCopy = {
  en: {
    badge: "RivalPeek $49/mo · we track competitors for $9.9/mo",
    ...
    productDemo: {
      ...
      preview:
        "📊 SaaS Price Tracker — Linear\n─────────────────────────────────────────────────────\n  📈 90-day     2 changes · Standard $8→$10 (+25%)\n  🔔 Alert      AI auto-classify moved to Plus tier\n  🎯 Compete    Height still $8.99/mo · Jira $8.15/seat\n  💡 Strategy   $8-10/mo is indie team sweet spot\n─────────────────────────────────────────────────────\n  [ View history ]    [ Set alert ]    [ Compare ]",
    },
  },
  zh: {
    badge: "RivalPeek $49/月 · 我们 $9.9/月自动追踪竞品",
    ...
    productDemo: {
      ...
      preview:
        "📊 SaaS 价格追踪 — Linear\n─────────────────────────────────────────────────────\n  📈 90 天     2 次变动 · Standard $8→$10（+25%）\n  🔔 提醒      AI 自动分类移至 Plus 计划\n  🎯 竞争      Height 仍 $8.99/月 · Jira $8.15/席位\n  💡 策略      $8-10/月是 indie 团队甜蜜点\n─────────────────────────────────────────────────────\n  [ 查看历史 ]    [ 设置提醒 ]    [ 对比 ]",
    },
  },
} as const;
