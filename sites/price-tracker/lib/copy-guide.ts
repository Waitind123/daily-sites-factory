...
export const guideCopy = {
  en: {
    meta: {
      ...
      description:
        "How to monitor Notion, Linear, Cursor pricing changes: manual vs automated, tool comparison, pricing strategy. Cheaper than RivalPeek at $9.9/mo.",
    },
    ...
    sections: [
      ...
      },
      {
        ...
        list: [
          ...
          "SaaS Price Tracker — $9.9/mo, pre-loaded indie stack + strategy tips",
    ...
    cta: {
      ...
      body: "5 free deep-dives. Daily checks, 90-day history, email alerts for $9.9/mo.",
  ...
  zh: {
    ...
    sections: [
      ...
      },
      {
        ...
        list: [
          ...
          "SaaS 价格追踪 — $9.9/月，预装 indie 常用栈 + 策略建议",
    ...
    cta: {
      ...
      body: "免费体验 5 次深度追踪。每日检查、90 天历史、邮件提醒，$9.9/月。",
      primary: "立即订阅 $9.9/月",
      secondary: "免费体验",
    },
  },
