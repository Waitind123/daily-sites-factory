...
export const homeCopy = {
  en: {
    badge: "Mailchimp $13+/mo? · $9.9/mo flat",
    title: "HTML emails for indie product updates",
    subtitle:
      "Build responsive product emails, preview live, copy HTML for Resend/Postmark. 5 free templates, then $9.9/mo.",
    ctaPrimary: "Create a template free",
    ctaPrimaryHref: "/templates",
    ctaSecondary: "Subscribe · $9.9/mo",
    ctaSecondaryHref: "/join",
    note: "5 free templates · then $9.9/mo",
    stats: [
      { stat: "$9.9", label: "flat/mo vs Mailchimp $13+" },
    ...
    features: [
      ...
      { icon: "💰", title: "Flat $9.9/mo", desc: "Unlimited templates. No per-contact fees like Mailchimp Essentials." },
    ],
    ...
    testimonials: [
      ...
      { name: "Priya S.", role: "Indie hacker", text: "Mailchimp wanted $13/mo before I had 500 subscribers. This does the job for $9.9." },
    ...
    closing: {
      ...
      subtitle: "5 free templates · then $9.9/mo for unlimited",
      ctaPrimary: "Create a template free",
  ...
  zh: {
    badge: "Mailchimp $13+/月？· $9.9/月一口价",
    title: "独立开发者的 HTML 产品邮件",
    subtitle: "搭建响应式产品邮件、实时预览、复制 HTML 用于 Resend/Postmark。免费体验 5 个模板，之后 $9.9/月。",
    ctaPrimary: "免费创建模板",
    ctaPrimaryHref: "/templates",
    ctaSecondary: "订阅 · $9.9/月",
    ctaSecondaryHref: "/join",
    note: "免费体验 5 个模板 · 之后 $9.9/月",
    stats: [
      { stat: "$9.9", label: "一口价/月，对比 Mailchimp $13+" },
    ...
    features: [
      ...
      { icon: "💰", title: "$9.9/月一口价", desc: "模板不限量，无 Mailchimp 按联系人收费。" },
    ],
    testimonialsTitle: "独立开发者怎么说",
    testimonials: [
      { name: "Alex M.", role: "独立创始人", text: "以前每次发版都要手写 HTML 表格，现在 10 分钟搞定。" },
      { name: "Priya S.", role: "独立开发者", text: "还没 500 订阅 Mailchimp 就要 $13/月，这个 $9.9 够用。" },
      { name: "Chris L.", role: "自举开发者", text: "复制 HTML 到 Resend，当天就发出了更新日志邮件。" },
    ],
    closing: {
      title: "更快发出产品邮件",
      subtitle: "免费体验 5 个模板 · 之后 $9.9/月不限量",
      ctaPrimary: "免费创建模板",
      ctaSecondary: "查看定价",
    },
    productDemo: {
