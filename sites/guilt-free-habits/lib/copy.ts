...
export const homeCopy = {
  en: {
    badge: "Streaks resets to zero · Habitica too gamified · $9.9/mo",
    title: "Habit tracker without streak anxiety",
    subtitle:
      "Weekly 4/7 goals — miss a day, keep your progress. 5 free check-ins, then $9.9/mo flat.",
    ctaPrimary: "Try free",
    ...
    stats: [
      ...
      { stat: "$9.9", label: "flat/mo vs Streaks $5+" },
    ...
    testimonials: [
      ...
      },
      {
        name: "Sarah L.",
        role: "Remote PM",
        text: "$9.9 is less than therapy copay. Missing Tuesday no longer ruins my month.",
      },
    ],
    closing: {
      title: "Streaks punishes one bad day. We don't.",
      subtitle: "Just $9.9/mo. Weekly goals, gentle progress, zero shame screens.",
  ...
  zh: {
    badge: "连续天数断链归零 · Habitica 太游戏化 · $9.9/月",
    title: "告别连续天数焦虑的习惯打卡",
    subtitle: "每周 4/7 天达标即可，错过一天不重置进度。免费体验 5 次，之后 $9.9/月一口价。",
    ctaPrimary: "免费体验",
    ctaPrimaryHref: "/track",
    ...
    stats: [
      ...
      { stat: "$9.9", label: "一口价/月，Streaks 要 $5+" },
    ...
    testimonials: [
      ...
      },
      {
        name: "Sarah",
        role: "远程产品经理",
        text: "$9.9 比一次咨询便宜。周二没打卡不再毁掉我整个月。",
      },
    ],
    closing: {
      title: "连续天数 App 惩罚你错过一天，我们不会",
      subtitle: "只要 $9.9/月。周目标、温和进度、零羞辱界面。",
      ctaPrimary: "开始追踪",
      ctaSecondary: "查看定价",
    },
    productDemo: {
