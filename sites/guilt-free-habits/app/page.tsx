      ...
      <section className="bg-surface border-y border-border py-12">
        <div className="mx-auto max-w-5xl px-4 sm:px-6">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <h2 className="text-xl font-bold mb-4">{c.weekChartTitle}</h2>
              <WeekChart locale={locale} />
            </div>
            <div>
              <h2 className="text-xl font-bold mb-4">{c.popularHabitsTitle}</h2>
              <div className="space-y-2">
                {c.defaultHabits.slice(0, 4).map((h) => (
                  <div
                    key={h.id}
