...
export const guideCopy = {
  en: {
    meta: {
      ...
      description:
        "85% of visitors leave your pricing page without buying. Compare Hotjar, Evelance, and PriceDiagnose. Learn conversion diagnosis, layout diagnosis, and A/B playbook at $9.9/mo.",
    },
    ...
    sections: [
      ...
      },
      {
        ...
        tools: [
          ...
          {
            h3: "Pricing Convert — $9.9/mo flat",
      ...
      },
      {
        ...
        paragraphs: [
          "You don't need a week of setup. Open Pricing Convert, paste your live /pricing URL, and review the generated report: conversion score (0–100), estimated conversion rate, heatmap zones with risk levels, drop-off points with fix suggestions, and A/B copy swaps with expected lift ranges.",
      ...
      },
      {
        ...
        closingLink: {
          href: "/join",
          label: "try Pricing Convert free",
  ...
  zh: {
    meta: {
      ...
      description:
        "85% 访客离开定价页未购买。对比 Hotjar、Crazy Egg、VWO 定价页诊断工具。学习热力图分析、流失修复与 A/B 测试建议，$9.9/月一口价。",
    },
    ...
    sections: [
      ...
      },
      {
        h2: "5 分钟完成第一次诊断",
        paragraphs: [
          "不需要一周部署。打开 Pricing Convert，粘贴线上 /pricing 链接，查看生成的报告：转化评分（0–100）、预估转化率、带风险等级的热力图分区、带修复建议的流失节点、以及带预期提升区间的 A/B 文案替换方案。",
