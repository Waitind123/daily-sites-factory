...
export const homeCopy = {
  en: {
    badge: "Notion lock-in? Obsidian solo? · $9.9/mo flat",
    title: "Team wiki that ships — without Notion tax",
    subtitle:
      "AI search, MCP integration, real-time collab. 5 free wiki spaces, then $9.9/mo unlimited pages.",
    ctaPrimary: "Create wiki free",
    ctaPrimaryHref: "/wiki",
    ctaSecondary: "Subscribe · $9.9/mo",
    ctaSecondaryHref: "/join",
    note: "5 free wiki spaces · then $9.9/mo",
    stats: [
      { stat: "$9.9", label: "flat/mo vs Notion $15+/seat" },
    ...
    testimonials: [
      {
        name: "Alex M.",
        role: "Solo founder",
        text: "Notion wanted $15/seat for 4 people. Wiki Pulse gave us unlimited team wiki for $9.9/mo flat.",
      },
      {
        name: "Priya S.",
        role: "Indie hacker",
    ...
    closing: {
      ...
      subtitle: "5 free wiki spaces · then $9.9/mo for unlimited",
      ctaPrimary: "Create wiki free",
  ...
  zh: {
    badge: "Notion 绑架数据？Obsidian 只能单人？· $9.9/月一口价",
    title: "团队知识库快速上线 — 不用交 Notion 税",
    subtitle:
      "AI 搜索、MCP 集成、实时协作。免费体验 5 个知识库空间，之后 $9.9/月无限页面。",
    ctaPrimary: "免费创建知识库",
    ctaPrimaryHref: "/wiki",
    ...
    stats: [
      { stat: "$9.9", label: "一口价/月，Notion 要 $15+/人" },
    ...
    testimonials: [
      {
        name: "Alex M.",
        role: "一人创始人",
        text: "Notion 4 个人要 $15/人。团队知识库 $9.9/月无限用。",
      },
      {
        name: "Priya S.",
        role: "独立开发者",
    ...
    closing: {
      title: "别再按人头为团队知识付费",
      subtitle: "免费 5 个知识库空间 · 之后 $9.9/月 不限量",
      ctaPrimary: "免费创建知识库",
      ctaSecondary: "查看定价",
    },
    productDemo: {
