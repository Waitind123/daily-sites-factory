...
export const roomCopy = {
  en: {
    ...
    chooseMode: "Choose cowork mode",
    online: "online",
    minutes: "min",
    ambientSounds: "Ambient sound",
    roomOnline: "Currently online",
    entering: "Entering…",
    ...
    sessionDoneUpsellCta: "Subscribe · $29/mo",
    liveStats: {
