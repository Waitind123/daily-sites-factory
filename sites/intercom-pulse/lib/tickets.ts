...
const kbArticles: KbArticle[] = [
  ...
  },
  {
    ...
    content:
      "Non-members get 5 free conversation actions (start chat or AI reply). Subscribe at /join for unlimited chat widget, AI agent, and help center editing.",
  },
  {
    id: "widget",
    title: "Chat widget embed",
    keywords: ["widget", "embed", "script", "install", "chat", "messenger", "组件", "嵌入", "脚本", "安装"],
    content:
      "Copy the embed script from Settings → Widget. Paste before </body> on your site. The messenger appears bottom-right. Customize colors in the dashboard (Pro).",
  },
  {
    id: "integration",
    ...
    content:
      "Connect Slack to get notified on new chats (Pro). Email forwarding and webhooks are on the roadmap — vote in feedback if you need them first.",
  },
  {
    id: "account",
    title: "Account & login",
