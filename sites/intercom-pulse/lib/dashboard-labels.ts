...
export const DASHBOARD_COPY = {
  ...
  chartsTitle: "指标可视化 Metrics Charts",
  chartsSub: "折线图、柱状图 · 同比/环比可展开 Line, bar charts · comparisons expandable",
  trendLineTitle: "趋势折线图 Trend",
  trendBarTitle: "每日柱状图 Daily Bars",
  funnelBarTitle: "转化漏斗柱状 Funnel Bars",
  metricsStackTitle: "指标对比堆叠 Metric Comparison",
  momLabel: "环比 MoM",
  yoyLabel: "同比 YoY",
  momRange: "环比对比期",
  yoyRange: "同比对比期",
  momPrev: "上期",
  comparisonToggleShow: "展开同比/环比 Show MoM / YoY",
  comparisonToggleHide: "收起同比/环比 Hide MoM / YoY",
  noChartData: "该时段暂无数据",
  siteCount: "站点数 Sites",
