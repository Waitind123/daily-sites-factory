...
export const homeCopy = {
  en: {
    ...
    stats: [
      { stat: "$29", label: "flat/mo vs World Time Buddy Pro" },
    ...
    testimonials: [
      ...
      },
      {
        ...
        text: "5 free runs for occasional use. Subscribed for weekly syncs — $29 beats wasted coordination time.",
      },
    ],
    closing: {
      title: "World Time Buddy shows time. We show who's suffering.",
      subtitle:
        "Cross-timezone meetings waste 31 minutes on average. $29/mo — day-one pricing because fair scheduling is worth paying for.",
  ...
  zh: {
    ...
    stats: [
      { stat: "$29", label: "一口价/月，World Time Buddy Pro 更贵" },
    ...
    testimonials: [
      ...
      },
      {
        name: "阿杰",
        role: "独立开发者",
        text: "5 次免费够偶尔用，每周固定站会就订阅了，$29 比浪费的协调时间便宜太多。",
      },
    ],
    closing: {
      title: "World Time Buddy 只显示时间，我们告诉你谁最惨",
      subtitle: "协调一次跨时区会议平均浪费 31 分钟。$29/月，第一天就设计收费点——因为公平调度值得付费。",
      ctaPrimary: "开始规划",
      ctaSecondary: "查看定价",
    },
    productDemo: {
