  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 sm:py-20">
      <div className="text-center mb-10">
        <h1 className="text-3xl font-bold text-foreground sm:text-4xl">加入 Meetup 组织助手</h1>
        <p className="mt-3 text-muted">
          一个价格，无限活动。没有按人头收费，没有隐藏费用。
        </p>
      </div>
      ...
      <div className="mt-8 rounded-xl border border-border bg-background p-6">
        ...
        <ul className="space-y-2 text-sm text-muted">
          <li>· Meetup.com Pro 一年 $170，我们 $9.9/月覆盖核心 RSVP 需求</li>
          <li>· 候补自动通知节省组织者每周 2+ 小时</li>
          <li>· 一人维护，$9.9 才能持续迭代提醒和签到功能</li>
        </ul>
      </div>
