...
export const joinCopy = {
  en: {
    ...
    whyItems: [
      "Meetup.com Pro costs $170/yr — we cover core RSVP at $9.9/mo",
      "Waitlist auto-notify saves organizers 2+ hours/week",
      "Solo-maintained — $9.9 keeps reminders & check-in features updated",
    ],
  ...
  zh: {
    ...
    whyItems: [
      "Meetup.com Pro 一年 $170，我们 $9.9/月覆盖核心 RSVP 需求",
      "候补自动通知节省组织者每周 2+ 小时",
      "一人维护，$9.9 才能持续迭代提醒和签到功能",
    ],
    includedTitle: "包含功能",
  },
} as const;
...
export const eventsCopy = {
  en: {
    ...
    subtitle:
      "View attendee lists, waitlist queues, reminder templates & check-in guides. 5 free tries, then $9.9/mo.",
  ...
  zh: {
    title: "活动 RSVP 管理",
    subtitle: "查看参与者名单、候补队列、提醒模板和签到指南。免费体验 5 次，之后 $9.9/月。",
