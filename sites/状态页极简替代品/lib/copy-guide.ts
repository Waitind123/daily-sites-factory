  ...
  en: {
    ...
    sections: [
      ...
      },
      {
        ...
        after: [
          "Many indie hackers use free UptimeRobot for monitoring and a dedicated status page tool for the public-facing communication. Status Lite focuses on the communication layer — post incidents, notify subscribers, embed a widget.",
        ],
      },
    ],
    cta: {
  ...
  zh: {
    ...
    sections: [
      ...
      },
      {
        ...
        after: [
          "很多独立开发者用免费 UptimeRobot 做监控，专用状态页工具做对外沟通。极简状态页专注沟通层 — 发事件、通知订阅者、嵌入组件。",
        ],
      },
    ],
    cta: {
