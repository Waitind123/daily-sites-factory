  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 sm:py-20">
      <div className="text-center mb-10">
        <h1 className="text-3xl font-bold text-foreground sm:text-4xl">Join Feature Vote</h1>
        <p className="mt-3 text-muted">One price, all features. No per-voter fees.</p>
      </div>
      ...
      <div className="mt-8 rounded-xl border border-border bg-background p-6">
        <h3 className="font-semibold text-foreground mb-3">Why 5 free boards, then subscribe?</h3>
        <ul className="space-y-2 text-sm text-muted">
          <li>· Hosting boards and voter notifications costs real infrastructure</li>
          <li>· Paying users = founders who actually listen to customers</li>
