...
export const studioCopy = {
  en: {
    ...
    paywallBody: "Like the results? One click to subscribe — unlimited generations.",
    paywallHint: "2 paying users = $20 goal. Cancel anytime.",
    paywallCta: "Subscribe · $9.9/mo",
    paywallCtaUsd: "Pay $9.9/mo (Polar)",
    paywallCtaCny: "Pay ¥69/mo (Alipay / WeChat)",
  ...
  zh: {
    ...
    paywallBody: "效果满意？一键订阅，继续无限生成。",
    paywallHint: "仅需 2 人付费即可覆盖 Cursor $20 续费。随时可取消。",
    paywallCta: "订阅 $9.9/月",
    paywallCtaUsd: "美元 $9.9/月（Polar）",
    paywallCtaCny: "人民币 ¥69/月（支付宝/微信）",
