...
export const studioCopy = {
  en: {
    ...
    paywallBody: "Subscribe $9.9/mo for unlimited proposals · 70% cheaper than HoneyBook",
    ...
    postGenerateBody: "Unlimited proposals + contract templates for $9.9/mo — 70% less than HoneyBook.",
  ...
  zh: {
    ...
    paywallBody: "订阅 $9.9/月，无限生成报价单 · 比 HoneyBook 便宜 70%",
    paywallCta: "立即订阅",
    yourInfo: "你的信息",
    clientInfo: "客户信息",
    projectDetails: "项目详情",
    ...
    postGenerateBody: "无限报价 + 合同模板，$9.9/月 — 比 HoneyBook 便宜 70%。",
