...
export const guideCopy = {
  en: {
    ...
    intro: [
      "GummySearch shut down November 30, 2025. 135,000+ founders lost their primary Reddit audience research tool overnight. Replacements emerged — but most miss the full picture.",
    ...
    sections: [
      {
        h2: "What GummySearch did — and what's missing now",
        paragraphs: [
      ...
      {
        h2: "2026 GummySearch alternatives compared",
        tools: [
          {
            h3: "GummySearch — shut down (was ~$29–79/mo)",
            p: "Reddit-only audience research. 135K+ users. Shut down November 2025. No competitor spy, no HN/PH coverage.",
          },
          {
            h3: "SpyCenter — $79–199/mo",
            p: "Audience Spy + Competitor Spy in one dashboard. Meta/Google ads, SEO keywords, G2 weaknesses, Reddit pain mining. Priced for funded teams.",
          },
          {
            h3: "PainHunt — $29+/mo",
      ...
      {
        h2: "How to use audience + competitor spy in 5 minutes",
        paragraphs: ["The fastest indie validation + positioning workflow:"],
        ordered: [
          "Enter a niche keyword in Audience Spy — scan Reddit, HN & Product Hunt for pain quotes",
        ...
        afterLink: {
          ...
          prefix: "Try ",
          suffix: " on spycenter.io or painhunt.com to see their ads and weaknesses in under a minute.",
        },
      },
      {
        h2: "Real example: audience pain + competitor gap to $3k MRR",
        paragraphs: [
  ...
  zh: {
    ...
    intro: [
      "GummySearch 于 2025 年 11 月 30 日关停，13.5 万+ 创始人一夜之间失去了主要的 Reddit 受众研究工具。替代品纷纷出现 — 但大多只覆盖一半需求。",
    ...
    sections: [
      ...
      {
        h2: "2026 GummySearch 替代品对比",
        tools: [
          {
            h3: "GummySearch — 已关停（曾约 $29–79/月）",
            p: "仅 Reddit 受众研究。13.5 万+ 用户。2025 年 11 月关停。无竞品侦察，无 HN/PH 覆盖。",
          },
          {
            h3: "SpyCenter — $79–199/月",
            p: "受众侦察 + 竞品侦察一体看板。Meta/Google 广告、SEO 关键词、G2 弱点、Reddit 痛点挖掘。面向有融资团队定价。",
          },
          {
            h3: "PainHunt — $29+/月",
      ...
      {
        h2: "5 分钟完成受众 + 竞品侦察",
        paragraphs: ["最快的独立开发者验证 + 定位流程："],
        ordered: [
          "在受众侦察输入细分领域关键词 — 扫描 Reddit、HN、Product Hunt 痛点引用",
        ...
        afterLink: {
          ...
          label: "竞品侦察",
          prefix: "用 ",
          suffix: " 侦察 spycenter.io 或 painhunt.com，一分钟内查看广告与弱点。",
        },
      },
      {
        h2: "真实案例：受众痛点 + 竞品缺口到 $3k MRR",
        paragraphs: [
