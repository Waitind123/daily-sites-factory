  ...
  return (
    <div className="mx-auto max-w-lg px-4 py-20 text-center sm:px-6">
      ...
      <div className="mt-10 space-y-3">
        <Link
          href="/"
          className="block w-full rounded-xl bg-indigo-600 px-6 py-3.5 font-semibold text-white transition-colors hover:bg-indigo-500"
        >
          查看完整城市榜
        </Link>
        <p className="text-sm text-zinc-600">社区邀请链接已发送至你的注册邮箱</p>
      </div>
    </div>
  );
}
