...
export const joinCopy = {
  en: {
    ...
    socialProof: "200+ cities · updated daily · built for indie nomads",
    recommended: "Best value",
    monthly: "Annual",
    perMonth: "/yr",
    vsCanny: "≈ $0.27/day · cancel anytime",
    compareTitle: "Nomad Cities vs Nomad List",
    compareHeaderUs: "Nomad Cities",
    compareHeaderThem: "Nomad List",
    compareRows: [
      { label: "Annual price", us: "$99/yr flat", them: "$99–$299/yr tiers" },
  ...
  zh: {
    ...
    socialProof: "200+ 城市 · 每日更新 · 为独立游民打造",
    recommended: "最佳方案",
    monthly: "年度会员",
    perMonth: "/年",
    vsCanny: "约 ¥1.9/天 · 无自动续费",
    compareTitle: "游民城市榜 vs Nomad List",
    compareHeaderUs: "游民城市榜",
    compareHeaderThem: "Nomad List",
    compareRows: [
      { label: "年费", us: "¥699/年一口价", them: "$99–$299/年多档" },
