...
export const joinCopy = {
  en: {
    ...
    subscribe: "Join · $9.9/mo",
    subscribeAnnual: "Join · $99/yr",
...
export const dashboardCopy = {
  en: {
    ...
    paywallCta: "Join · $9.9/mo",
    stickyTrialTitle: "Only {n} free unlocks left",
    stickyTrialBody: "Unlock all 200+ cities with a membership — from $9.9/mo.",
