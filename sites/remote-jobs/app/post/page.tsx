...
export default async function PostPage() {
  ...
  return (
    <div className="mx-auto max-w-xl px-4 py-12 sm:px-6">
      ...
      <p className="text-muted mb-8">会员无限发帖，24h 内审核上线</p>

      <form className="space-y-5 rounded-xl border border-border bg-surface p-6">
        <div>
          <label className="block text-sm font-medium text-foreground mb-1">职位名称</label>
          <input
            type="text"
        ...
        <div>
          <label className="block text-sm font-medium text-foreground mb-1">薪资范围</label>
          <input
            type="text"
        ...
        <div>
          <label className="block text-sm font-medium text-foreground mb-1">职位描述</label>
          <textarea
            rows={5}
        ...
        <div>
          <label className="block text-sm font-medium text-foreground mb-1">申请链接</label>
          <input
            type="url"
            placeholder="https://..."
            className="w-full rounded-lg border border-border px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500"
