...
export const postCopy = {
  en: {
    ...
    lockedBody: "$9.9/mo for unlimited remote job posts — reach quality candidates directly.",
    lockedCta: "Join · $9.9/mo",
  ...
  zh: {
    ...
    lockedBody: "$9.9/月可无限发布远程职位，直达高质量求职者。",
    lockedCta: "加入会员 · $9.9/月",
    title: "发布远程职位",
