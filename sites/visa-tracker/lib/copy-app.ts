...
export const joinCopy = {
  en: {
    title: "Join Visa Tracker",
    subtitle: "One price, unlimited tracking. No hidden fees.",
    recommended: "Recommended",
    monthly: "Monthly",
    perMonth: "/mo",
    vsCompetitor: "~$0.33/day · cancel anytime",
    perks: [
      "Unlimited visa tracking & policy alerts",
      "30-day & 7-day expiry email reminders",
      "Policy change diff for 35+ programs",
      "Auto-generated renewal checklists",
      "Timeline planner for multi-visa nomads",
      "Weekly verified policy updates",
    ],
...
export const successCopy = {
  en: {
    title: "Welcome to Visa Tracker!",
    demoPaid: "Demo payment successful.",
    paidPrefix: "Payment successful —",
    paidBody: "you now have unlimited visa tracking and policy alerts.",
    order: "Order:",
    openVisas: "Open tracker",
...
export const stripeProductCopy = {
  en: {
    name: "Visa Tracker · Monthly",
    description: "Visa policy tracking, expiry alerts & renewal checklists.",
  },
  zh: {
    name: "签证追踪器 · 月付",
    description: "签证政策追踪、到期提醒与续签清单",
  },
} as const;
