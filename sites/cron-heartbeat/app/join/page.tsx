  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 sm:py-20">
      <div className="text-center mb-10">
        <h1 className="text-3xl font-bold text-foreground sm:text-4xl">Join Cron Heartbeat</h1>
        <p className="mt-3 text-muted">One price, all features. No per-monitor fees.</p>
      </div>
      ...
      <div className="rounded-2xl border-2 border-brand-600 bg-surface p-8 shadow-lg relative overflow-hidden">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-muted">
            vs Cronitor $29+/mo · cancel anytime
          </p>
        </div>
      ...
      <div className="mt-8 rounded-xl border border-border bg-background p-6">
        <h3 className="font-semibold text-foreground mb-3">Why 5 free jobs, then subscribe?</h3>
        <ul className="space-y-2 text-sm text-muted">
          <li>· Alert delivery and schedule scanning cost real infrastructure</li>
          <li>· Paying users = founders who actually run production crons</li>
