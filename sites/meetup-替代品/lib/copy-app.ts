...
export const joinCopy = {
  en: {
    ...
    whyItems: [
      "Meetup.com organizer fee is $25-45/mo — we flat $9.9 with export included",
      "Past events vanish on Meetup when you cancel — here your data stays yours",
      "Solo-maintained — $9.9 keeps embed widget & export features updated",
    ],
  ...
  zh: {
    ...
    whyItems: [
      "Meetup.com 组织者费用 $25-45/月 — 我们 $9.9/月固定价含导出",
      "Meetup 取消后历史活动消失 — 这里数据永远归你",
      "一人维护，$9.9 才能持续迭代嵌入组件与导出功能",
    ],
    includedTitle: "包含功能",
  },
} as const;
...
export const eventsCopy = {
  en: {
    ...
    subtitle:
      "Branded RSVP pages, waitlist, embed widget & CSV export. 5 free tries, then $9.9/mo.",
  ...
  zh: {
    title: "社区活动管理",
    subtitle: "品牌 RSVP 页面、候补、嵌入组件与 CSV 导出。免费体验 5 次，之后 $9.9/月。",
