...
export const homeCopy = {
  en: {
    badge: "Plausible has no funnels · $29/mo flat",
    title: "Tracetics Lite — funnel analytics for indie hackers",
    subtitle:
      "Plausible can't do funnels. Mixpanel costs $500/mo. See drop-off, fix leaks, grow MRR. 5 free funnels, then $29/mo.",
    ...
    testimonials: [
      {
        ...
        text: "Mixpanel wanted $500/mo for funnel analytics. I have 200 users. Tracetics Lite shows me the same drop-off chart for $29.",
      },
      {
        name: "Mia T.",
        role: "Indie hacker",
  ...
  zh: {
    badge: "Plausible 没有漏斗 · $29/月一口价",
    title: "Tracetics Lite — 独立开发者漏斗分析",
    subtitle:
      "Plausible 做不了漏斗，Mixpanel 要 $500/月。看清流失、修复漏洞、提升 MRR。免费体验 5 个漏斗，之后 $29/月。",
    ctaPrimary: "免费创建漏斗",
    ctaPrimaryHref: "/funnels",
    ...
    testimonials: [
      {
        name: "Alex K.",
        role: "一人 SaaS 创始人",
        text: "Mixpanel 漏斗分析要 $500/月，我只有 200 用户。Tracetics Lite $29 就能看到同样的流失图。",
      },
      {
        name: "Mia T.",
        role: "独立开发者",
