...
export const publicFunnelCopy = {
  en: {
    poweredBy: "Powered by Tracetics Lite · funnel analytics for indie hackers",
    step: "Step",
    users: "Users",
    rate: "Conv. rate",
    dropOff: "Drop-off",
  ...
  zh: {
    poweredBy: "由 Tracetics Lite 提供 · 独立开发者漏斗分析",
    step: "步骤",
    users: "用户数",
    rate: "转化率",
    dropOff: "流失率",
...
export const successCopy = {
  en: {
    title: "Welcome to Tracetics Lite!",
