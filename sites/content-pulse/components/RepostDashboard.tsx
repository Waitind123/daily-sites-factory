...
import type { RepostBatch, Platform } from "@/lib/repost";
import { getPlatformLabel } from "@/lib/repost";
...
export function RepostDashboard({ locale }: { locale: Locale }) {
  ...
  const [batch, setBatch] = useState<RepostBatch | null>(null);
  const [batches, setBatches] = useState<RepostBatch[]>([]);
