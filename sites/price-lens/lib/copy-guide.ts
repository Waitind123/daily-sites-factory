...
export const guideCopy = {
  en: {
    meta: {
      title: "2026 Pricing Page Conversion Audit Guide for Indie Hackers",
      description:
        "85% of visitors leave your pricing page without buying. Compare Hotjar, Crazy Egg, and VWO for pricing optimization. Learn heatmap analysis, drop-off fixes, and A/B test ideas at $9.9/mo.",
    },
    h1: "2026 Pricing Page Conversion Audit Guide for Indie Hackers",
    ...
    intro: [
      ...
      "Pricing page conversion is the highest-leverage metric for indie hackers. A 2% improvement on a page that gets 1,000 visits/month can mean 20 extra customers — without spending a dollar on ads. The problem? Hotjar charges $39/month for heatmaps. Crazy Egg starts at $29/mo. VWO wants $198/mo for A/B testing. FullStory and session replay tools are even pricier.",
      "On Indie Hackers, founders repeatedly post: \"I know my pricing page is leaking, but I can't justify $39/mo on Hotjar when I have 50 paying customers.\" Another wrote: \"I changed my CTA from 'Get started' to 'Start free — no card' and conversion jumped 18%. Wish I'd audited sooner.\"",
      "This guide explains why pricing pages leak visitors, what to measure without enterprise tools, how to prioritize fixes by revenue impact, and how to run your first pricing page audit in under 5 minutes.",
    ],
    sections: [
      {
      ...
      {
        h2: "2026 pricing page audit tools compared",
        tools: [
          {
            h3: "Hotjar — $39+/mo",
            p: "Industry-standard heatmaps and session recordings. Excellent for teams with dedicated growth staff. Overkill for solo founders who just want to know why /pricing converts at 1.8% instead of 3%. Pricing scales with daily sessions.",
          },
          {
            h3: "Crazy Egg — $29+/mo",
            p: "Scroll maps and click heatmaps focused on layout optimization. Good for content sites, less tailored to SaaS tier comparison patterns. No A/B test suggestions built in.",
          },
          {
            h3: "VWO — $198+/mo",
          ...
          {
            h3: "PriceLens — $9.9/mo flat",
            p: "Built for indie hackers: paste your /pricing URL, get attention heatmap zones, drop-off funnel analysis, and copy-level A/B suggestions with expected lift. 5 free audits, no SDK install, no session replay bloat.",
            link: { href: "/analyze", text: "Audit my pricing page", suffix: " — five free scans, no credit card." },
          },
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          "You don't need a week of setup. Open PriceLens, paste your live /pricing URL, and review the generated report: conversion score (0–100), estimated conversion rate, heatmap zones with risk levels, drop-off points with fix suggestions, and A/B copy swaps with expected lift ranges.",
    ...
    sections: [
      ...
      },
      {
        ...
        tools: [
          ...
          {
            h3: "Crazy Egg — $29+/月",
            p: "滚动图与点击热力图，侧重布局优化。适合内容站，对 SaaS 档位对比模式针对性弱。无内置 A/B 测试建议。",
          },
          {
            h3: "VWO — $198+/月",
      ...
      },
      {
        h2: "5 分钟完成第一次诊断",
        paragraphs: [
          "不需要一周部署。打开 PriceLens，粘贴线上 /pricing 链接，查看生成的报告：转化评分（0–100）、预估转化率、带风险等级的热力图分区、带修复建议的流失节点、以及带预期提升区间的 A/B 文案替换方案。",
