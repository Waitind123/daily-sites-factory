...
export const homeCopy = {
  en: {
    badge: "Statuspage.io $29+/mo? · $9.9/mo flat",
    title: "Status pages for indie hackers",
    subtitle:
    ...
    stats: [
      { stat: "$9.9", label: "flat/mo vs Statuspage.io $29+" },
    ...
    testimonials: [
      {
        ...
        text: "45-minute outage, 60 support tickets asking 'is it down?' Status Pulse paid for itself in one incident.",
      },
      {
        name: "Mia T.",
        role: "Indie hacker",
  ...
  zh: {
    ...
    stats: [
      { stat: "$9.9", label: "一口价/月，Statuspage.io 要 $29+" },
    ...
    productDemo: {
      ...
      preview:
        "🟢 所有系统运行正常\n─────────────────────────────────\n  API          ● 正常\n  网站         ● 正常\n  数据库       ● 正常\n─────────────────────────────────\n  📧 12 位订阅者 · statuspulse.app/s/my-saas\n\n  近期事件：\n  ✓ 已解决 · API 延迟升高 · 2 小时前\n  ● 调查中 · 部署进行中 · 刚刚",
    },
  },
} as const;
...
export const joinCopy = {
  ...
  zh: {
    ...
    monthly: "月付",
    perMonth: "/月",
    vsCanny: "对比 Statuspage.io $29+/月 · 随时可取消",
    perks: [
      "不限状态页数量",
      "不限邮件订阅者",
      "事件管理与时间线",
