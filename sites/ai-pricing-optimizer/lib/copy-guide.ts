...
export const guideCopy = {
  en: {
    ...
    intro: [
      ...
      "Pricing page conversion is the highest-leverage metric for indie hackers. A 2% improvement on a page that gets 1,000 visits/month can mean 20 extra customers — without spending a dollar on ads. The problem? Wynter charges $500+ per pricing page test. Evelance and PriceOptimize start at $49–149/mo. Enterprise UX research is priced for funded teams, not solo founders.",
      "On Indie Hackers, founders repeatedly post: \"I know my pricing copy is weak, but I can't justify $500 on Wynter when I have 50 paying customers.\" Another wrote: \"AI rewrote my headline from feature-first to outcome-first and conversion jumped 23%. Wish I'd optimized sooner.\"",
      "This guide explains why pricing pages leak visitors, how AI copy rewrites and layout diagnosis help without enterprise budgets, how to prioritize fixes by revenue impact, and how to run your first AI optimization in under 5 minutes.",
    ],
    sections: [
      {
      ...
      },
      {
        ...
        paragraphs: [
          "You don't need a week of setup. Open PricePulse AI, paste your live /pricing URL, and review the generated report: conversion score (0–100), estimated conversion rate, heatmap zones with risk levels, drop-off points with fix suggestions, and A/B copy swaps with expected lift ranges.",
  ...
  zh: {
    ...
    sections: [
      ...
      },
      {
        h2: "5 分钟完成第一次诊断",
        paragraphs: [
          "不需要一周部署。打开 PricePulse AI，粘贴线上 /pricing 链接，查看生成的报告：转化评分（0–100）、预估转化率、带风险等级的热力图分区、带修复建议的流失节点、以及带预期提升区间的 A/B 文案替换方案。",
