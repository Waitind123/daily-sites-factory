...
export const homeCopy = {
  en: {
    ...
    subtitle:
      "Generate 1200×630 social share images, meta tags, and Next.js snippets. $29/mo vs Bannerbear $49/mo — pure SVG, no Puppeteer.",
    ctaPrimary: "Try free",
    ...
    stats: [
      { stat: "$29", label: "flat/mo vs Bannerbear $49" },
    ...
    closing: {
      ...
      subtitle:
        "Product Hunt, blog SEO, Twitter promos — OG images drive clicks. $29/mo, 80% cheaper than Bannerbear.",
  ...
  zh: {
    ...
    title: "独立开发者 OG 图生成器",
    subtitle:
      "一键生成 1200×630 社交分享图、meta 标签和 Next.js 片段。$29/月，Bannerbear $49/月的 1/5 价格，纯 SVG 渲染。",
    ctaPrimary: "免费体验",
    ctaPrimaryHref: "/studio",
    ...
    stats: [
      { stat: "$29", label: "一口价/月，Bannerbear $49" },
    ...
    closing: {
      title: "好产品需要好看的分享图",
      subtitle:
        "Product Hunt 发布、博客 SEO、Twitter 推广——OG 图决定点击率。$29/月，比 Bannerbear 便宜 80%。",
      ctaPrimary: "开始生成",
