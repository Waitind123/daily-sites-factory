...
export const joinCopy = {
  en: {
    ...
    whyItems: [
      "Dynares $99/mo is overkill for indie ad budgets — we do 80% for $9.9",
      "Manual Webflow pages take 2 hours per ad group — we batch in 60 seconds",
      "Solo-maintained — $9.9 keeps keyword templates and SEO rules updated",
    ],
  ...
  zh: {
    ...
    whyItems: [
      "Dynares $99/月对 indie 广告预算太贵 — 我们 $9.9 做到 80%",
      "Webflow 手动做每广告组要 2 小时 — 我们 60 秒批量完成",
      "一人维护，$9.9 才能持续更新关键词模板和 SEO 规则",
    ],
    includedTitle: "包含功能",
  },
} as const;
