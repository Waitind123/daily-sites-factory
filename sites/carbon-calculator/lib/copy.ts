...
export const homeCopy = {
  en: {
    badge: "Watershed $50k/yr · Excel chaos · $29/mo",
    title: "Remote work carbon footprint calculator",
    subtitle:
      "Compare full office vs hybrid vs fully remote emissions. 5 free calculations, then $29/mo flat.",
    ctaPrimary: "Try free",
    ctaPrimaryHref: "/calculate",
    ctaSecondary: "Subscribe · $29/mo",
    ctaSecondaryHref: "/join",
    note: "5 free calculations · then $29/mo",
    stats: [
    ...
    closing: {
      ...
      subtitle:
        "Just $29/mo. Baseline in 5 minutes — day-one pricing because ESG data needs ongoing maintenance.",
  ...
  zh: {
    badge: "Watershed 年费 5 万+ · Excel 太乱 · $29/月",
    title: "远程办公碳足迹计算器",
    subtitle: "对比全勤、混合、完全远程碳排放。免费体验 5 次，之后 $29/月一口价。",
    ctaPrimary: "免费体验",
    ctaPrimaryHref: "/calculate",
    ...
    closing: {
      ...
      subtitle: "我们只要 $29/月。5 分钟出基线，第一天就设计收费点——因为 ESG 数据也需要持续维护。",
      ctaPrimary: "开始计算",
      ctaSecondary: "查看定价",
    },
    productDemo: {
