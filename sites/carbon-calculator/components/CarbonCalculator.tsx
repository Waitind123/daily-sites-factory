...
export function CarbonCalculator() {
  ...
  return (
    <div className="space-y-6">
      ...
      <form onSubmit={handleCalculate} className="rounded-2xl border border-stone-200 bg-white p-6 space-y-5">
        <div>
        ...
        <div>
          <label className="block text-sm font-medium text-stone-700 mb-2">通勤方式</label>
        ...
        <div>
          <label className="block text-sm font-medium text-stone-700 mb-2">电网区域</label>
          <select
            value={gridRegion}
      ...
      {result && (
        <div className="space-y-4">
          <div className="rounded-2xl border-2 border-brand-600 bg-brand-50 p-6 text-center">
            <p className="text-sm text-brand-700 font-medium">相比全勤通勤，你每年减排</p>
            ...
            {[result.fullOffice, result.current, result.fullRemote].map((s) => (
              <div key={s.label} className="rounded-xl border border-stone-200 bg-white p-4">
                ...
                <p className="text-2xl font-bold text-stone-900 mt-1">
                  ...
                  <span className="text-sm font-normal text-stone-400 ml-1">kg/年</span>
                </p>
