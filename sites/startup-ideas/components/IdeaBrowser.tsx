      ...
      <div className="grid gap-4 sm:grid-cols-2">
        {ideas.map((idea) => (
          ...
          >
            ...
            <h3 className="font-bold text-lg text-stone-900">{idea.title}</h3>
            <p className="text-sm text-stone-500 mt-1">{idea.tagline}</p>
            <p className="text-sm text-stone-600 mt-3 line-clamp-2">{idea.preview}</p>
      ...
      {selected && (
        ...
        >
          ...
          >
            ...
            {loading && (
              <div className="text-center py-12 text-stone-400">加载深度分析中...</div>
            )}
            ...
            {analysis && (
              <div className="space-y-6 text-sm">
                <section>
                  ...
                  <p className="text-stone-600">{analysis.problem}</p>
                </section>
                <section>
                  <h3 className="font-bold text-base mb-2">📈 市场规模</h3>
                  <p className="text-stone-600">{analysis.marketSize}</p>
                </section>
                <section>
                      ...
                      <tbody>
                        {analysis.competitors.map((c) => (
                          <tr key={c.name} className="border-b border-stone-100">
                            ...
                            <td className="py-2 pr-4 text-brand-600">{c.pricing}</td>
                            <td className="py-2 text-stone-500">{c.gap}</td>
                          </tr>
                        ))}
                      </tbody>
                    </table>
                ...
                <section>
                  ...
                  <p className="text-stone-600">{analysis.monetization}</p>
                </section>
                <section>
