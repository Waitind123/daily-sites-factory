...
export const homeCopy = {
  en: {
    badge: "BigIdeasDB $9/mo · IdeaProof $49/mo · $29/mo",
    title: "Curated startup ideas with deep market analysis",
    subtitle:
      "8+ validated micro-SaaS directions. 5 free deep analyses, then $29/mo unlimited.",
    ctaPrimary: "Try free",
    ctaPrimaryHref: "/ideas",
    ctaSecondary: "Subscribe · $29/mo",
    ctaSecondaryHref: "/join",
    note: "5 free deep analyses · then $29/mo",
    stats: [
      { stat: "8+", label: "curated ideas & growing" },
      { stat: "$29", label: "flat/mo vs IdeaProof $49+" },
    ...
    testimonials: [
      ...
      },
      {
        ...
        text: "$29 pays for itself with one idea. Already shipped an API usage tracker MVP.",
      },
    ],
    closing: {
      title: "BigIdeasDB is too expensive. Twitter inspiration is too scattered.",
      subtitle:
        "Just $29/mo. Curated ideas + deep analysis to ship the right thing. Day-one pricing because research has real costs.",
  ...
  zh: {
    badge: "BigIdeasDB $9/月 · IdeaProof $49/月 · $29/月",
    title: "精选创业点子 + 深度市场分析",
    subtitle: "8+ 可落地微 SaaS 方向。免费体验 5 次深度分析，之后 $29/月无限阅读。",
    ctaPrimary: "免费体验",
    ctaPrimaryHref: "/ideas",
    ...
    stats: [
      ...
      { stat: "$29", label: "一口价/月，IdeaProof 要 $49+" },
    ...
    closing: {
      ...
      subtitle:
        "只要 $29/月。精选点子 + 深度分析，帮你 ship 对的 thing。第一天收费，因为 research 也有成本。",
      ctaPrimary: "浏览点子",
      ctaSecondary: "查看定价",
    },
    productDemo: {
...
export const joinCopy = {
  en: {
    ...
    whyItems: [
      ...
      "Solo-maintained — $29 keeps new ideas coming",
    ],
