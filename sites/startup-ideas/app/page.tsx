      ...
      <section className="bg-surface border-y border-border py-12">
        <div className="mx-auto max-w-5xl px-4 sm:px-6">
          <div className="rounded-2xl border-2 border-brand-200 bg-brand-600/10 p-6 sm:p-8">
            ...
            <h2 className="text-2xl font-bold text-foreground">{c.todayIdea.title}</h2>
            <p className="text-muted mt-2">{c.todayIdea.tagline}</p>
            <p className="text-sm text-muted mt-3 line-clamp-2">{c.todayIdea.preview}</p>
            <div className="flex flex-wrap items-center gap-4 mt-4">
              <span className="text-sm text-brand-500 font-medium">
                MRR {c.todayIdea.mrrPotential}
              </span>
              <span className="text-sm text-muted">· {c.todayIdea.buildTime}</span>
              <Link
                href="/ideas"
