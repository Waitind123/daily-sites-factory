...
export const homeCopy = {
  en: {
    ...
    howItWorks: {
      title: "Three steps to library focus",
      steps: [
        {
          step: "1",
          title: "Pick a mode",
    ...
    liveStatsTitle: "Live library stats",
...
export const joinCopy = {
  en: {
    title: "Join Library Cowork",
    subtitle: "One price, all features. No free tier, no hidden fees.",
    recommended: "Recommended",
    monthly: "Monthly",
    perMonth: "/mo",
    vsCanny: "vs Study Hall $20+/mo · cancel anytime",
    perks: [
      "Unlimited library sessions",
  ...
  zh: {
    ...
    monthly: "月付",
    perMonth: "/月",
    vsCanny: "对比 Study Hall $20+/月 · 随时可取消",
    perks: [
      "无限阅览室会话",
      "4 种共工模式（深度/番茄/创意/晨间）",
