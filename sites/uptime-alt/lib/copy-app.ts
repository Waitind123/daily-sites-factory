...
export const joinCopy = {
  en: {
    title: "Join UptimeAlt",
    subtitle: "One price — uptime monitoring and status pages after the UptimeRobot hike.",
    recommended: "Recommended",
    monthly: "Monthly",
    perMonth: "/mo",
    vsCanny: "vs UptimeRobot $34+ after 4× hike · cancel anytime",
    perks: [
  ...
  zh: {
    title: "订阅 Uptime 涨价替代品",
    subtitle: "一口价 — UptimeRobot 涨价后的监控 + 状态页二合一。",
    recommended: "推荐",
    monthly: "月付",
    perMonth: "/月",
    vsCanny: "对比 UptimeRobot 涨价后 $34+ · 随时可取消",
    perks: [
      "无限 URL Uptime 检测",
      "1 分钟 HTTP 监控",
      "带组件的公开状态页",
