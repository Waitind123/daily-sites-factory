...
export const homeCopy = {
  en: {
    badge: "Habitica too gamified · Notion too complex · $29/mo",
    title: "Minimal habit tracker for indie hackers",
    subtitle:
      "One tap check-in, streak tracking, weekly reports. 5 free check-ins, then $29/mo flat.",
    ctaPrimary: "Try free",
    ...
    stats: [
      { stat: "$29", label: "flat/mo vs Habitica $8+" },
    ...
    testimonials: [
      ...
      },
      {
        name: "Jay W.",
        role: "Freelancer",
        text: "$29 is less than a self-help book I'll never finish. Streaks actually work.",
      },
    ],
    closing: {
      title: "Habitica is too gamified. Notion is too complex.",
      subtitle: "Just $29/mo. Open → tap → close. Day-one pricing because simple still needs maintenance.",
  ...
  zh: {
    badge: "Habitica 太游戏化 · Notion 太复杂 · $29/月",
    title: "独立开发者的极简习惯打卡",
    subtitle: "一键打卡、连续天数、周报表。免费体验 5 次，之后 $29/月一口价。",
    ctaPrimary: "免费体验",
    ctaPrimaryHref: "/track",
    ...
    stats: [
      { stat: "$29", label: "一口价/月，Habitica 要 $8+" },
    ...
    testimonials: [
      ...
      },
      {
        name: "老王",
        role: "自由职业",
        text: "$29 不贵，比买一本不会看的自律书有用多了。",
      },
    ],
    closing: {
      title: "Habitica 太游戏化，Notion 太复杂",
      subtitle: "只要 $29/月。打开 → 打卡 → 关闭。第一天收费，因为简单也需要持续维护。",
      ctaPrimary: "开始打卡",
      ctaSecondary: "查看定价",
    },
    productDemo: {
