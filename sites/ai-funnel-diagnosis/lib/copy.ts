...
export const homeCopy = {
  en: {
    ...
    subtitle:
      "Paste your funnel data. Get AI-powered drop-off analysis + actionable fix suggestions. No $500/mo analytics bill. 5 free diagnoses, then $29/mo.",
    ctaPrimary: "Diagnose my funnel free",
    ctaPrimaryHref: "/diagnose",
    ctaSecondary: "Subscribe · $29/mo",
    ctaSecondaryHref: "/join",
    note: "5 free AI diagnoses · then $29/mo",
    stats: [
    ...
    testimonials: [
      ...
      },
      {
        ...
        text: "I paste funnel data from my spreadsheet every Monday. Five fix suggestions, one shipped per week. Best $29 I spend.",
      },
    ],
    closing: {
      title: "Stop staring at charts — start fixing leaks",
      subtitle: "5 free AI diagnoses · then $29/mo for unlimited",
      ctaPrimary: "Diagnose my funnel free",
  ...
  zh: {
    ...
    subtitle:
      "粘贴漏斗数据，获得 AI 流失分析 + 可执行的修复建议。无需 $500/月 分析账单。免费体验 5 次诊断，之后 $29/月。",
    ctaPrimary: "免费诊断我的漏斗",
    ctaPrimaryHref: "/diagnose",
    ctaSecondary: "订阅 · $29/月",
    ctaSecondaryHref: "/join",
    note: "免费体验 5 次 AI 诊断 · 之后 $29/月",
    stats: [
    ...
    testimonials: [
      ...
      },
      {
        name: "Chris P.",
        role: "自举开发者",
        text: "每周一从表格粘贴漏斗数据。五条修复建议，每周上线一条。最值的 $29。",
      },
    ],
    closing: {
      title: "别只盯着图表 — 开始修复漏洞",
      subtitle: "免费体验 5 次 AI 诊断 · 之后 $29/月无限次",
      ctaPrimary: "免费诊断我的漏斗",
      ctaSecondary: "查看定价",
    },
    productDemo: {
