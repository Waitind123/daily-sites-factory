...
export const homeCopy = {
  en: {
    badge: "CSRD 2026 · Watershed $50k/yr · $9.9/mo",
    title: "Scope 3 employee commuting baseline",
    subtitle:
      "Collect team commute data, calculate Cat.7 emissions, export CSRD-ready reports. 5 free team baselines, then $9.9/mo.",
    ctaPrimary: "Try free",
    ctaPrimaryHref: "/survey",
    ctaSecondary: "Subscribe · $9.9/mo",
    ctaSecondaryHref: "/join",
    note: "5 free team baselines · then $9.9/mo",
    stats: [
    ...
    features: [
      ...
      { icon: "💰", title: "SME pricing", desc: "$9.9/mo flat — no per-seat fees like enterprise platforms" },
    ],
    testimonialsTitle: "What users say",
    testimonials: [
      { name: "Elena M.", role: "CSO · 85-person SaaS", text: "CSRD deadline in 8 weeks. Watershed quoted €40k. We baselined Cat.7 in one afternoon for $9.9/mo." },
    ...
    closing: {
      ...
      subtitle: "$9.9/mo. Baseline your team in 15 minutes — day-one pricing because CSRD data needs ongoing updates.",
  ...
  zh: {
    badge: "CSRD 2026 · Watershed 年费 5 万+ · $9.9/月",
    title: "Scope 3 员工通勤排放基线",
    subtitle: "收集团队通勤数据，计算第 7 类排放，导出 CSRD 合规报告。免费体验 5 次团队基线，之后 $9.9/月。",
    ctaPrimary: "免费体验",
    ctaPrimaryHref: "/survey",
    ctaSecondary: "订阅 · $9.9/月",
    ctaSecondaryHref: "/join",
    note: "免费体验 5 次团队基线 · 之后 $9.9/月",
    stats: [
    ...
    features: [
      ...
      { icon: "💰", title: "中小企业定价", desc: "$9.9/月一口价 — 无企业平台按人头收费" },
    ],
    testimonialsTitle: "用户怎么说",
    testimonials: [
      { name: "Elena M.", role: "CSO · 85 人 SaaS", text: "CSRD 截止还有 8 周。Watershed 报价 €4 万。我们一个下午出完第 7 类基线，$9.9/月。" },
    ...
    closing: {
      ...
      subtitle: "$9.9/月。15 分钟出团队基线，第一天就设计收费点 — CSRD 数据需要持续更新。",
      ctaPrimary: "开始团队调研",
      ctaSecondary: "查看定价",
    },
    productDemo: {
...
export const joinCopy = {
  en: {
    ...
    whyItems: [
      ...
      "Solo-maintained — $9.9 keeps it sustainable vs Watershed $50k",
    ],
  ...
  zh: {
    ...
    whyItems: [
      ...
      "一人维护，$9.9 才能持续运营，Watershed 要 5 万+",
    ],
    includedTitle: "包含功能",
  },
} as const;
