...
export const dashboardCopy = {
  en: {
    ...
    subtitle: "Connect Stripe, sync MRR/churn/cohorts, track retention weekly.",
    memberBadge: "✓ Member · unlimited syncs",
    freeSyncs: "Free syncs remaining:",
    paywallTitle: "Free trial used up",
    paywallBody:
      "You've used 5 free syncs. Subscribe for unlimited Stripe syncs, cohort analysis, and CSV export.",
    paywallCta: "Subscribe · $19.9/mo",
    ...
    createdHint: "Click sync to pull your MRR, churn, and cohort metrics.",
    syncNow: "Sync now",
    syncing: "Syncing…",
  ...
  zh: {
    title: "订阅分析仪表盘",
    subtitle: "连接 Stripe，同步 MRR/流失率/队列，每周追踪留存。",
    memberBadge: "✓ 会员 · 同步不限量",
    freeSyncs: "剩余免费同步次数：",
    paywallTitle: "免费体验已用完",
    paywallBody: "你已使用 5 次免费同步。订阅后可无限同步 Stripe 数据、查看队列分析并导出 CSV。",
    paywallCta: "订阅 · $19.9/月",
    createTitle: "新建仪表盘",
    productName: "产品名称",
    ...
    createdTitle: "仪表盘已创建！",
    createdHint: "点击同步拉取 MRR、流失率和队列数据。",
    syncNow: "立即同步",
    syncing: "同步中…",
...
export const successCopy = {
  en: {
    title: "Welcome to Stripe Pulse Lite!",
    demoPaid: "Demo payment successful.",
    paidPrefix: "Payment successful —",
    paidBody: "you now have unlimited Stripe syncs, cohort analysis, and CSV export.",
    order: "Order:",
    openDashboard: "Open dashboard",
    backHome: "Back to home",
  },
  zh: {
    title: "欢迎使用 Indie 订阅分析！",
    demoPaid: "演示支付成功。",
    paidPrefix: "支付成功 —",
    paidBody: "你现在可以无限同步 Stripe 数据、查看队列分析并导出 CSV。",
    order: "订单号：",
    openDashboard: "打开仪表盘",
    backHome: "返回首页",
  },
...
export const stripeProductCopy = {
  en: {
    name: "Stripe Pulse Lite · Monthly",
    description: "Unlimited Stripe syncs, MRR/churn dashboard & cohort retention analysis.",
  },
  zh: {
    name: "Indie 订阅分析 · 月付",
    description: "无限 Stripe 同步、MRR/流失仪表盘与队列留存分析。",
  },
} as const;
